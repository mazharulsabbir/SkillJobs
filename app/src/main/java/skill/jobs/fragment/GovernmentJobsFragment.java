...
public class GovernmentJobsFragment extends Fragment {
    private static final String TAG = "GovernmentJobsFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_government_jobs, container, false);

        mRecyclerViewFeatureJobs = view.findViewById(R.id.recycler_view_govt_jobs);
    ...
    private void featureJobsAdapter(final List<JobsData> data) {
        //jobsList.clear();
        mFeatureJobsAdapter = new JobsContainerAdapter(R.layout.example_layout_jobs, data);
